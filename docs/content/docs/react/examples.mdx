---
title: Examples
description: Real-world examples of using gill-react in your applications
---

Learn how to use gill-react through practical examples that demonstrate common patterns and use cases.
...
import { useTokenAccount, useTokenMint } from "gill-react";
...
import { TOKEN_PROGRAM_ID } from "gill/programs/token";
...
Combine gill-react with Solana wallet adapter:
...
import { useAccount, useTokenAccount } from "gill-react";
...
- [Full Example App](https://github.com/DecalLabs/gill/tree/main/examples/react-app) - Complete React application using gill-react
