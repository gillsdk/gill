...
>(
...
): UpdatePrimarySaleHappenedViaTokenInstruction<TProgramAddress, TAccountMetadata, TAccountOwner, TAccountToken> {
  // Program address.
  ...
  const instruction = {
    accounts: [getAccountMeta(accounts.metadata), getAccountMeta(accounts.owner), getAccountMeta(accounts.token)],
    programAddress,
    data: getUpdatePrimarySaleHappenedViaTokenInstructionDataEncoder().encode({}),
  } as UpdatePrimarySaleHappenedViaTokenInstruction<TProgramAddress, TAccountMetadata, TAccountOwner, TAccountToken>;
