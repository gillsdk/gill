...
> {
  return combineCodec(getSetTokenStandardInstructionDataEncoder(), getSetTokenStandardInstructionDataDecoder());
}
...
>(
  input: SetTokenStandardInput<TAccountMetadata, TAccountUpdateAuthority, TAccountMint, TAccountEdition>,
...
export function parseSetTokenStandardInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
