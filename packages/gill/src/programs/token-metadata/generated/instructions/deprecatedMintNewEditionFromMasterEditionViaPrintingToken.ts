...
export function getDeprecatedMintNewEditionFromMasterEditionViaPrintingTokenDiscriminatorBytes() {
  return getU8Encoder().encode(DEPRECATED_MINT_NEW_EDITION_FROM_MASTER_EDITION_VIA_PRINTING_TOKEN_DISCRIMINATOR);
}
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountPrintingMint extends string ? WritableAccount<TAccountPrintingMint> : TAccountPrintingMint,
      TAccountMasterTokenAccount extends string
        ? WritableAccount<TAccountMasterTokenAccount>
        : TAccountMasterTokenAccount,
      TAccountEditionMarker extends string ? WritableAccount<TAccountEditionMarker> : TAccountEditionMarker,
      ...
      ...(TAccountReservationList extends undefined
        ? []
        : [
            TAccountReservationList extends string ? WritableAccount<TAccountReservationList> : TAccountReservationList,
          ]),
      ...TRemainingAccounts,
    ]
  >;

export type DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionData = { discriminator: number };
...
>(
...
): ParsedDeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionDataDecoder().decode(instruction.data),
  };
}
