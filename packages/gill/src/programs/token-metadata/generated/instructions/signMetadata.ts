...
> {
  return combineCodec(getSignMetadataInstructionDataEncoder(), getSignMetadataInstructionDataDecoder());
}

export type SignMetadataInput<TAccountMetadata extends string = string, TAccountCreator extends string = string> = {
...
export function parseSignMetadataInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
