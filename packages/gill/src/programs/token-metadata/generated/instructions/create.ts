...
import { getCreateArgsDecoder, getCreateArgsEncoder, type CreateArgs, type CreateArgsArgs } from "../types";
...
export function parseCreateInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
