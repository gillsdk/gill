...
> {
  return combineCodec(getCloseAccountsInstructionDataEncoder(), getCloseAccountsInstructionDataDecoder());
}
...
>(
  input: CloseAccountsInput<TAccountMetadata, TAccountEdition, TAccountMint, TAccountAuthority, TAccountDestination>,
...
export function parseCloseAccountsInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
