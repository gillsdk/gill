...
import { getPrintArgsDecoder, getPrintArgsEncoder, type PrintArgs, type PrintArgsArgs } from "../types";
...
export type PrintInstruction<
  ...
  TAccountSplAtaProgram extends string | AccountMeta<string> = "ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL",
  TAccountSysvarInstructions extends string | AccountMeta<string> = "Sysvar1nstructions1111111111111111111111111",
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      TAccountEditionMetadata extends string ? WritableAccount<TAccountEditionMetadata> : TAccountEditionMetadata,
      TAccountEdition extends string ? WritableAccount<TAccountEdition> : TAccountEdition,
      TAccountEditionMint extends string ? WritableAccount<TAccountEditionMint> : TAccountEditionMint,
      ...
      TAccountEditionMintAuthority extends string
        ? ReadonlySignerAccount<TAccountEditionMintAuthority> & AccountSignerMeta<TAccountEditionMintAuthority>
      ...
      TAccountMasterEdition extends string ? WritableAccount<TAccountMasterEdition> : TAccountMasterEdition,
      TAccountEditionMarkerPda extends string ? WritableAccount<TAccountEditionMarkerPda> : TAccountEditionMarkerPda,
      ...
      TAccountMasterMetadata extends string ? ReadonlyAccount<TAccountMasterMetadata> : TAccountMasterMetadata,
      ...
      TAccountSplAtaProgram extends string ? ReadonlyAccount<TAccountSplAtaProgram> : TAccountSplAtaProgram,
...
export function getPrintInstructionDataCodec(): FixedSizeCodec<PrintInstructionDataArgs, PrintInstructionData> {
...
>(
  ...
  (typeof input)["masterTokenAccountOwner"] extends TransactionSigner<TAccountMasterTokenAccountOwner>
    ? ReadonlySignerAccount<TAccountMasterTokenAccountOwner> & AccountSignerMeta<TAccountMasterTokenAccountOwner>
    : TAccountMasterTokenAccountOwner,
  TAccountMasterTokenAccount,
  TAccountMasterMetadata,
  TAccountUpdateAuthority,
...
export function parsePrintInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
