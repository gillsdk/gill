...
export function getUtilizeInstructionDataCodec(): FixedSizeCodec<UtilizeInstructionDataArgs, UtilizeInstructionData> {
...
export function parseUtilizeInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
