  ...
  InstructionWithAccounts<
    [
      ...
      TAccountCollectionAuthority extends string
        ? WritableSignerAccount<TAccountCollectionAuthority> & AccountSignerMeta<TAccountCollectionAuthority>
...
> {
  return combineCodec(getVerifyCollectionInstructionDataEncoder(), getVerifyCollectionInstructionDataDecoder());
}
...
export function parseVerifyCollectionInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
