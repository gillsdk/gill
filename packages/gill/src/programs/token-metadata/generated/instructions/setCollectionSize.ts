...
> {
  return combineCodec(getSetCollectionSizeInstructionDataEncoder(), getSetCollectionSizeInstructionDataDecoder());
}
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getSetCollectionSizeInstructionDataEncoder().encode(args as SetCollectionSizeInstructionDataArgs),
