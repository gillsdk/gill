...
export function getVerifyInstructionDataCodec(): FixedSizeCodec<VerifyInstructionDataArgs, VerifyInstructionData> {
...
export function parseVerifyInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
