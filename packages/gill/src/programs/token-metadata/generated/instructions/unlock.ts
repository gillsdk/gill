...
import { getUnlockArgsDecoder, getUnlockArgsEncoder, type UnlockArgs, type UnlockArgsArgs } from "../types";
...
export function getUnlockInstructionDataCodec(): Codec<UnlockInstructionDataArgs, UnlockInstructionData> {
...
export function parseUnlockInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
