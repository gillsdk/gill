...
import { getUpdateArgsDecoder, getUpdateArgsEncoder, type UpdateArgs, type UpdateArgsArgs } from "../types";
...
export function getUpdateInstructionDataCodec(): Codec<UpdateInstructionDataArgs, UpdateInstructionData> {
...
export function parseUpdateInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
