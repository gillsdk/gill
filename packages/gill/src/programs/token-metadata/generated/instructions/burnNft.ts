...
export function getBurnNftInstructionDataCodec(): FixedSizeCodec<BurnNftInstructionDataArgs, BurnNftInstructionData> {
...
export function parseBurnNftInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
