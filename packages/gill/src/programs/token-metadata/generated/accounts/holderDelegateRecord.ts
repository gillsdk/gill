...
export function getHolderDelegateRecordCodec(): FixedSizeCodec<HolderDelegateRecordArgs, HolderDelegateRecord> {
...
export function decodeHolderDelegateRecord<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getHolderDelegateRecordDecoder());
}
