...
export function getMetadataDelegateRecordCodec(): FixedSizeCodec<MetadataDelegateRecordArgs, MetadataDelegateRecord> {
...
export function decodeMetadataDelegateRecord<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getMetadataDelegateRecordDecoder());
}
