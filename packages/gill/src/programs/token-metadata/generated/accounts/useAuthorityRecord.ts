...
export function getUseAuthorityRecordCodec(): FixedSizeCodec<UseAuthorityRecordArgs, UseAuthorityRecord> {
...
export function decodeUseAuthorityRecord<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getUseAuthorityRecordDecoder());
}
