...
export function getCollectionAuthorityRecordCodec(): Codec<CollectionAuthorityRecordArgs, CollectionAuthorityRecord> {
...
): Account<CollectionAuthorityRecord, TAddress> | MaybeAccount<CollectionAuthorityRecord, TAddress> {
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getCollectionAuthorityRecordDecoder());
}
