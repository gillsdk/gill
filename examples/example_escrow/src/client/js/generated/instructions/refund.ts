...
export function getRefundInstructionDataCodec(): FixedSizeCodec<RefundInstructionDataArgs, RefundInstructionData> {
  return combineCodec(getRefundInstructionDataEncoder(), getRefundInstructionDataDecoder());
}
...
export function parseRefundInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
